                            ...
                            <div className="row">
                                ...
                                <div className="clearfix col-md-3 col-sm-6 col-xs-12 text-footer">
                                    ...
                                    <ul className="icon-footer">
                                        <li><i className="fa fa-home" aria-hidden="true" /> tanjung barat,jakarta selatan indonesia</li>
                                        <li><i className="fa fa-envelope" aria-hidden="true" /> ardidwiwork@gmail.com</li>
                                        <li><i className="fa fa-phone" aria-hidden="true" />081289262467</li>
                            ...
                            <div className=" container">
                                <div className="row">
                                    <div className="clearfix col-md-7 clear-padding copyright">
                                        <p>Copyright © 2020 by Dii project. All Rights Reserved.</p>
                                    </div>
